...
// Init generic settings required for both partial and full updates. Can play around with this once the display is working ok
...
//to play around with partial LUTs
...
// Sets the display up in partial mode
