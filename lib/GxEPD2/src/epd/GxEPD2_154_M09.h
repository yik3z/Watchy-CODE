...
class GxEPD2_154_M09 : public GxEPD2_EPD
{
  public:
    ...
    void writeImageAgain(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool partialupdate, bool invert = false, bool mirror_y = false, bool pgm = false);
